...
int main() {
  ...
  // Define some values to manage position
  int lane = 1;
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // Main car's localization Data
              ...
              // Either we will reference the starting point as where the car is or the previous paths end points
              double ref_x = car_x;
              double ref_y = car_y;
              ...
              {
                // Redfine reference state as previous path end point
              ...
              vector<double> next_wp0 = getXY(car_s + 30, lane_width * (lane + 0.5), map_waypoints_s, map_waypoints_x, map_waypoints_y);
              vector<double> next_wp1 = getXY(car_s + 60, lane_width * (lane + 0.5), map_waypoints_s, map_waypoints_x, map_waypoints_y);
              vector<double> next_wp2 = getXY(car_s + 90, lane_width * (lane + 0.5), map_waypoints_s, map_waypoints_x, map_waypoints_y);
              ...
              // Calculate how to break up sline points so that we travel at our desired reference velocity
